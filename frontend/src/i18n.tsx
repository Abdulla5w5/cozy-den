...
const dict: Record<string, { en: string; ar: string }> = {
  ...
  'bk.floorHint': { en: 'Hover to peek · click to choose', ar: 'مرّر على الطاولة للتفاصيل · واضغط للاختيار' },
  ...
  'bk.hoverTip': { en: 'Tip: hover over a table for a quick availability peek.', ar: 'معلومة: مرّروا على أي طاولة عشان تشوفون المتاح بسرعة.' },
