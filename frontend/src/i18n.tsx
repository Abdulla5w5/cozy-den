...
const dict: Record<string, { en: string; ar: string }> = {
  ...
  'home.hero.move': { en: 'Your move.', ar: 'نقلتك.' },
  'home.hero.people': { en: 'Your people.', ar: 'ربعك.' },
  'home.hero.den': { en: 'Your den.', ar: 'دنّكم.' },
  'home.proof.title': { en: 'Good nights start here.', ar: 'الليلة الحلوة تبدأ من هني.' },
  'home.proof.sub': {
    en: 'Board games, bites & your favorite people.',
    ar: 'ألعاب، أكل، والناس اللي تحبهم.',
  },
  ...
  'home.noRulebook': { en: 'No rulebook needed', ar: 'ما يحتاج تقرون القوانين' },
