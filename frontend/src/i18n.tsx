...
const dict: Record<string, { en: string; ar: string }> = {
  ...
  'home.sub': {
    en: 'Book your table online for as long as you like, then pick from 400+ tabletop games and order great food when you arrive. Your den, your rules.',
    ar: 'احجز طاولتك أونلاين للمدة اللي تناسبكم، ولما توصل اختار من أكثر من ٤٠٠ لعبة واطلب اللي يعجبك. المكان مكانكم والجو جوّكم.',
  },
  ...
  'bk.seats': { en: '{n} seats', ar: '{n} أشخاص' },
  'bk.nextGame': { en: 'Next: choose a game', ar: 'التالي: اختر لعبة' },
  'bk.sessionHint': {
    en: 'Two hours by default — stay longer if you like. After-midnight times belong to the evening you select.',
    ar: 'ساعتين افتراضياً، وتقدرون تمددون. أوقات بعد نص الليل تتبع الليلة اللي اخترتها.',
  },
  'bk.mapKicker': { en: 'Choose your corner', ar: 'اختاروا قعدتكم' },
  'bk.mapTitle': { en: 'Pick your spot in the Den', ar: 'اختاروا مكانكم في الدن' },
  'bk.mapSub': {
    en: 'Explore the cafe, choose the table that suits your crew, then grab an open start time.',
    ar: 'لفّوا على خريطة الكافيه، اختاروا الطاولة اللي تناسب جمعتكم، وثبّتوا الوقت المتاح.',
  },
  'bk.hours': { en: 'Open 2 PM – 3 AM', ar: 'نفتح من ٢ الظهر إلى ٣ الفجر' },
  'bk.lastSeating': { en: 'Last seating at 2 AM', ar: 'آخر حجز يبدأ الساعة ٢' },
  'bk.chooseDate': { en: 'First, choose your night', ar: 'أول شي، اختاروا الليلة' },
  'bk.chooseDateHint': { en: 'Availability updates instantly', ar: 'الأوقات تتحدّث على طول' },
  'bk.floorPlan': { en: 'Cafe floor plan', ar: 'خريطة الكافيه' },
  'bk.floorHint': { en: 'Choose a table to see its available times', ar: 'اختاروا طاولة عشان تشوفون الأوقات المتاحة' },
  ...
  'bk.tablesUnavailableSub': { en: 'Check the connection and try again.', ar: 'تأكدوا من الاتصال وحاولوا مرة ثانية.' },
  'bk.retryTables': { en: 'Try again', ar: 'حاول مرة ثانية' },
  'bk.seatsShort': { en: '{n} seats', ar: '{n} أشخاص' },
  'bk.openSlots': { en: '{n} open times', ar: '{n} موعد متاح' },
  'bk.noOpenSlots': { en: 'Fully booked', ar: 'محجوزة بالكامل' },
  'bk.tableMapLabel': {
    en: '{table}, {seats} seats, {slots} open times',
    ar: '{table}، تسع {seats} أشخاص، وفيها {slots} موعد متاح',
  },
  ...
  'cat.nameAr': { en: 'Name (Arabic)', ar: 'الاسم بالعربي' },
  'cat.descriptionAr': { en: 'Description (Arabic)', ar: 'الوصف بالعربي' },
  'cat.section': { en: 'Menu section', ar: 'قسم المنيو' },
  'cat.sectionHint': { en: 'e.g. Coffee, Ramen', ar: 'مثال: قهوة، رامن' },
  'cat.sectionAr': { en: 'Section (Arabic)', ar: 'القسم بالعربي' },
  'cat.displayOrder': { en: 'Order', ar: 'الترتيب' },
  'cat.displayOrderHint': { en: 'Lower shows first', ar: 'الأقل يظهر أول' },
  ...
  'bk.onePerson': { en: '1 person', ar: 'شخص واحد' },
  'bk.stayUntil': { en: 'Until', ar: 'إلى' },
  'bk.stayLength': { en: 'How long?', ar: 'كم مدة؟' },
  'bk.hoursShort': { en: '{n}h', ar: '{n} ساعة' },
  'bk.lateSeating': { en: 'Last seating', ar: 'آخر جلسة' },
  'bk.lateSeatingHint': {
    en: 'We close at 3 AM, so this sitting runs until then at our late rate.',
    ar: 'نسكر ٣ الفجر، فهذي الجلسة تمتد لين السكر بسعر الجلسة المتأخرة.',
  },
  'bk.blocks': { en: '{n} × 2-hour block', ar: '{n} × بلوك ساعتين' },
  'bk.blocksPlural': { en: '{n} × 2-hour blocks', ar: '{n} × بلوكات ساعتين' },
  'bk.legend': { en: 'Floor plan legend', ar: 'دليل خريطة الكافيه' },
  'bk.available': { en: 'Available', ar: 'متاحة' },
  'bk.selected': { en: 'Selected', ar: 'اختيارك' },
  'bk.unavailable': { en: 'No times left', ar: 'ما بقى وقت' },
  'bk.yourTable': { en: 'Your table', ar: 'طاولتكم' },
  'bk.pickTime': { en: 'Pick a start time', ar: 'اختاروا وقت البداية' },
  'bk.open': { en: 'Open', ar: 'متاح' },
  'bk.taken': { en: 'Taken', ar: 'محجوز' },
  'bk.selection': { en: 'Your selection', ar: 'اختياركم' },
  'bk.chooseTime': { en: 'Choose an open time', ar: 'اختاروا وقت متاح' },
  'bk.selectPrompt': { en: 'Choose a table on the map', ar: 'اختاروا طاولة من الخريطة' },
  'bk.selectPromptSub': {
    en: 'Its open times will appear here, ready to book.',
    ar: 'أول ما تختارون، بتطلع لكم هني كل الأوقات المتاحة للحجز.',
  },
  'bk.hoverTip': { en: 'Choose any table to see live availability and time slots.', ar: 'اختاروا أي طاولة وراح تظهر لكم الأوقات المتاحة مباشرة.' },
  ...
  'auth.stat2v': { en: '400+ titles', ar: '+٤٠٠ لعبة' },
  ...
  'auth.phone': { en: 'Kuwait phone number', ar: 'رقم الهاتف الكويتي' },
  'auth.phonePh': { en: '+965 5000 0000', ar: '+965 5000 0000' },
  'auth.phoneHint': {
    en: 'Enter an 8-digit Kuwait number. Only staff can see it.',
    ar: 'أدخل رقم كويتي من ٨ خانات. يظهر للموظفين فقط.',
  },
  'auth.phoneInvalid': {
    en: 'Enter a valid Kuwait phone number before continuing with Google.',
    ar: 'أدخل رقم هاتف كويتي صحيح قبل المتابعة مع جوجل.',
  },
  ...
  'about.eyebrow': { en: "Kuwait's first board game cafe", ar: 'أول كافيه ألعاب بورد في الكويت' },
  'about.title': { en: 'More than a cafe', ar: 'أكثر من مجرد كافيه' },
  'about.sub': {
    en: 'A welcoming community hub where global board-game culture meets Kuwaiti hospitality.',
    ar: 'مساحة ترحّب بالجميع، وتجمع ثقافة ألعاب البورد العالمية مع روح الضيافة الكويتية.',
  },
  'about.storyTitle': { en: 'From Board Games Panda to Cozy Den', ar: 'من Board Games Panda إلى كوزي دن' },
  'about.storyBody': {
    en: "Cozy Den officially opened in June 2024, but our story began in 2016 with Board Games Panda, one of Kuwait's earliest board-game companies. After years of introducing modern games to families, hobbyists, and first-time players, we created a permanent home for that community - a place to connect, create, and play.",
    ar: 'افتتح كوزي دن أبوابه رسمياً في يونيو ٢٠٢٤، لكن الحكاية بدأت سنة ٢٠١٦ مع «Board Games Panda»، إحدى أوائل الشركات المتخصصة بألعاب البورد في الكويت. وبعد سنوات من تعريف العائلات والهواة واللاعبين الجدد على عالم الألعاب الحديثة، صنعنا لهذا المجتمع مكاناً دائماً يلتقون فيه، يبدعون، ويلعبون.',
  },
  'about.conceptTitle': { en: 'A better way to get together', ar: 'جمعة أحلى، من أول لعبة' },
  'about.conceptBody': {
    en: 'Choose your table and tell us what kind of night you want. Our Game Masters help your group find the right game, explain the rules, and get everyone playing. Add specialty coffee, mocktails, desserts, and lighter options, and you have an easy night out built around real connection.',
    ar: 'اختاروا طاولتكم وقولوا لنا شنو الجو اللي تبونه. فريق الـGame Masters يساعدكم تلقون اللعبة المناسبة لعددكم ومزاجكم، يشرح القوانين، ويدخل الكل باللعبة من أول جولة. ومع القهوة المختصة والموكتيلات والحلويات والخيارات الخفيفة، تصير عندكم طلعة كاملة أساسها اللمة الحلوة.',
  },
  'about.pillar.games': { en: 'Games for every table', ar: 'لعبة لكل جمعة' },
  'about.pillar.games.body': {
    en: 'A carefully curated library for families, party groups, curious newcomers, and dedicated strategists.',
    ar: 'مكتبة مختارة بعناية تناسب العائلات، وجمعات الأصدقاء، واللاعبين الجدد، ومحبي ألعاب التخطيط.',
  },
  'about.pillar.food': { en: 'More than game-night snacks', ar: 'مو بس سناكات' },
  'about.pillar.food.body': {
    en: 'Specialty coffee, mocktails, desserts, air-baked meals, salads, and sugar-free choices keep every kind of player happy.',
    ar: 'من القهوة المختصة والموكتيلات والحلويات إلى الوجبات المحضّرة بطريقة صحية والسلطات والخيارات الخالية من السكر؛ عندنا شيء يناسب كل لاعب.',
  },
  'about.pillar.people': { en: 'Community comes first', ar: 'المجتمع أولاً' },
  'about.pillar.people.body': {
    en: "Themed nights, family programs, kids' workshops, corporate events, and regulars who treat the Den like their social home.",
    ar: 'ليالي بمواضيع مختلفة، وبرامج للعائلات، وورش للأطفال، وفعاليات للشركات، ورواد دائمون صار الدن مكانهم المفضل للّمة.',
  },
  'about.visitTitle': { en: 'Come for the games. Stay for the people.', ar: 'تعالوا عشان الألعاب، وبتردون عشان الناس.' },
  'about.visitBody': {
    en: 'Find us at Aswaq Al Qurain and discover a space designed for good games, good food, and better company. Whether it is your first visit or your weekly ritual, your table is waiting.',
    ar: 'زورونا في أسواق القرين واكتشفوا مكاناً مصمماً للعب الحلو، والأكل الطيب، والجمعة الأحلى. سواء كانت أول زيارة لكم أو موعدكم الأسبوعي، طاولتكم ناطرتكم.',
  },
  ...
  'cust.hint': {
    en: 'Registered customers and their contact details. Phone numbers are visible only to staff.',
    ar: 'العملاء المسجّلون وبيانات التواصل معهم. أرقام الموبايل تظهر للموظفين فقط.',
  },
