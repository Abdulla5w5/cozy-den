...
const dict: Record<string, { en: string; ar: string }> = {
  ...
  'home.step2b': {
    en: 'A small per-person holding fee secures your session.',
  ...
  'pr.latePeak': {
    en: 'Late seating — peak, per person (KD)',
    ar: 'الجلسة المتأخرة — الذروة، للشخص (د.ك)',
  },
  'pr.lateOffPeak': {
    en: 'Late seating — off-peak, per person (KD)',
    ar: 'الجلسة المتأخرة — عادي، للشخص (د.ك)',
  },
  ...
  'ev.reserve': { en: 'Reserve a seat', ar: 'احجز مقعد' },
  'ev.seats': { en: 'Seats', ar: 'المقاعد' },
  'ev.phone': { en: 'Phone', ar: 'رقم التلفون' },
  'ev.seatsLeft': { en: '{n} seats left', ar: 'باقي {n} مقاعد' },
  'ev.soldOut': { en: 'Fully booked', ar: 'اكتمل العدد' },
  'ev.openSeating': { en: 'Open seating', ar: 'مقاعد مفتوحة' },
  'ev.freeSeat': { en: 'Free', ar: 'مجاناً' },
  'ev.payAndReserve': { en: 'Pay {amount} & reserve', ar: 'ادفع {amount} واحجز' },
  'ev.confirmFree': { en: 'Confirm reservation', ar: 'أكد الحجز' },
  'ev.reserved': { en: 'Reserved. Your reference is', ar: 'تم الحجز. رقم حجزك' },
  'ev.reserveFailed': { en: 'Could not reserve those seats.', ar: 'ما قدرنا نحجز المقاعد.' },
  'ev.tableHold': { en: 'Holds a table', ar: 'يحجز طاولة' },
  'cat.evTable': { en: 'Table (optional)', ar: 'الطاولة (اختياري)' },
  'cat.evStart': { en: 'Start time', ar: 'وقت البداية' },
  'cat.evLength': { en: 'Length', ar: 'المدة' },
  'cat.evCapacity': { en: 'Seats (blank = no limit)', ar: 'المقاعد (فاضي = بلا حد)' },
  'cat.evSeatPrice': { en: 'Price per seat (KD)', ar: 'سعر المقعد (د.ك)' },
  'cat.evNoTable': { en: 'No table', ar: 'بدون طاولة' },
  'cat.evWho': { en: 'Who booked', ar: 'من حجز' },
  'cat.evNobody': { en: 'Nobody yet', ar: 'ما حد حجز' },
  'wb.length': { en: '{n}-hour session', ar: 'جلسة {n} ساعات' },
  'wb.reserveFor': { en: 'Reserve — {amount}', ar: 'احجز — {amount}' },
  'wb.reservedAlready': { en: 'Reserved', ar: 'محجوزة' },
  'wb.reserveFailed': { en: 'Could not reserve that listing.', ar: 'ما قدرنا نحجز الإعلان.' },
  'wb.sessionLength': { en: 'Session length', ar: 'مدة الجلسة' },
  'receipt.length': { en: 'Length', ar: 'المدة' },
  'receipt.party': { en: 'Guests', ar: 'عدد الضيوف' },
  ...
  'staff.floorHint': { en: 'Pick a table to see its bookings that day, 2 PM – 2 AM', ar: 'اختاروا طاولة عشان تشوفون حجوزاتها ذاك اليوم، ٢ الظهر – ٢ الفجر' },
  'staff.floorLive': { en: 'Live now', ar: 'مباشر الحين' },
  'staff.legendFree': { en: 'Free all day', ar: 'فاضية طول اليوم' },
  'staff.legendBooked': { en: 'Has bookings', ar: 'فيها حجوزات' },
  'staff.legendLive': { en: 'Seated now', ar: 'جالسين الحين' },
  'staff.bookingsCount': { en: '{n} bookings', ar: '{n} حجز' },
  'staff.seatedUntil': { en: '{name} · until {time}', ar: '{name} · لين {time}' },
  'staff.nextAt': { en: 'Next: {time} · {name}', ar: 'الجاي: {time} · {name}' },
  'staff.allDone': { en: 'All sessions finished', ar: 'كل الجلسات خلصت' },
  'staff.freeAllDay': { en: 'Free all day', ar: 'فاضية طول اليوم' },
  'staff.pickTable': { en: 'Pick a table', ar: 'اختاروا طاولة' },
  'staff.pickTableSub': { en: 'See who sat there, who is there now, and who is coming.', ar: 'شوفوا منو جلس فيها، منو فيها الحين، ومنو جاي.' },
  'staff.noTableBookings': { en: 'Nothing booked on this table that day.', ar: 'ما في حجوزات على هالطاولة ذاك اليوم.' },
  ...
  'wb.perPlayer': { en: '{amount} per seat', ar: '{amount} لكل مقعد' },
  'wb.seats': { en: 'Seats', ar: 'المقاعد' },
  'wb.seatsLeft': { en: '{n} seats still open', ar: 'باقي {n} مقاعد' },
  'wb.oneSeatLeft': { en: 'Last seat', ar: 'آخر مقعد' },
  'wb.reserveSeat': { en: 'Take a seat — {amount}', ar: 'احجز مقعد — {amount}' },
  'wb.reserveSeats': { en: 'Take {n} seats — {amount}', ar: 'احجز {n} مقاعد — {amount}' },
  ...
  'staff.wbSeats': {
    en: 'Seats sold: {taken} of {max} · {amount} per seat',
    ar: 'المقاعد المباعة: {taken} من {max} · {amount} للمقعد',
  },
  'staff.wbSeatCount': { en: '{n} seat(s)', ar: '{n} مقعد' },
  'staff.wbSeatPending': { en: 'payment pending', ar: 'الدفع معلّق' },
  'staff.pricing': { en: 'Pricing', ar: 'الأسعار' },
  'pr.baseTitle': { en: 'Standard rates', ar: 'الأسعار الأساسية' },
  'pr.baseHelp': {
    en: 'Per person, for a two-hour session — a party of four pays four times this. Thursday, Friday and Saturday use the weekend rate.',
    ar: 'للشخص الواحد، لجلسة ساعتين — مجموعة من ٤ أشخاص تدفع أربعة أضعاف. الخميس والجمعة والسبت بسعر نهاية الأسبوع.',
  },
  'pr.peak': { en: 'Weekend, per person (KD)', ar: 'نهاية الأسبوع، للشخص (د.ك)' },
  'pr.offPeak': { en: 'Other days, per person (KD)', ar: 'باقي الأيام، للشخص (د.ك)' },
  'pr.overrideTitle': { en: 'Special dates', ar: 'تواريخ خاصة' },
  'pr.overrideHelp': {
    en: 'Set a different per-person price for one date — a holiday, a discount day, or an event. This wins over the standard rates.',
  ...
  'pr.price': { en: 'Price per person (KD)', ar: 'السعر للشخص (د.ك)' },
  ...
  'status.arrived': { en: 'Arrived', ar: 'وصل' },
  ...
  'staff.printBtn': { en: 'Print receipt', ar: 'اطبع الإيصال' },
  'staff.completeBtn': { en: 'Mark done', ar: 'إنهاء' },
  ...
  'receipt.fee': { en: 'Holding fee', ar: 'رسوم الحجز' },
